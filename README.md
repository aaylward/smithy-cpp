...
| 3 | Client generation (restJson1 + rpcv2Cbor) | 🔨 In progress — serde + working clients for both protocols ([docs/generated-types.md](docs/generated-types.md)); official protocol-test suites + typed errors next (3b) |
