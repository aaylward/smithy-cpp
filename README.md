...
| Phase | Scope | Status |
|---|---|---|
| 0 | Foundations: Bazel 9 workspace, codegen skeleton, CI, ADRs, fixture models | **In progress** |
| 1 | C++ runtime library (`smithy/core`, `json`, `cbor`, `http`, `client`, `server`) | Not started |
