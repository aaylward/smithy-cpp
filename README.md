...
| 4 | Server generation (restJson1 + rpcv2Cbor) | 🔨 In progress — handlers, routing, serde, error mapping, smoke tests, and 220 server-mode conformance cases green ([docs/server-guide.md](docs/server-guide.md)); constraint validation + malformed-request tests next (4c) |
