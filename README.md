...
| 4 | Server generation (restJson1 + rpcv2Cbor) | 🔨 In progress — handlers, routing, serde, error mapping + generated smoke tests ([docs/server-guide.md](docs/server-guide.md)); constraint validation + server protocol tests next (4b) |
