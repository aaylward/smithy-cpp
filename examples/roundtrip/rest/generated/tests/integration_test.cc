...
DescribeSinkOutput RandomDescribeSinkOutput(Rng& rng) {
...
PutSinkInput RandomPutSinkInput(Rng& rng) {
  PutSinkInput v{};
  v.sinkId = std::string("0");
...
UploadAttachmentInput RandomUploadAttachmentInput(Rng& rng) {
...
UploadAttachmentOutput RandomUploadAttachmentOutput(Rng& rng) {
