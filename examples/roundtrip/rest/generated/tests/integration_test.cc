...
DescribeSinkError RandomDescribeSinkError([[maybe_unused]] Rng& rng) {
  DescribeSinkError v{};
  v.message = rng.Text(1, 9);
  return v;
}

DescribeSinkInput RandomDescribeSinkInput([[maybe_unused]] Rng& rng) {
  DescribeSinkInput v{};
...
DescribeSinkOutput RandomDescribeSinkOutput([[maybe_unused]] Rng& rng) {
...
PutSinkInput RandomPutSinkInput([[maybe_unused]] Rng& rng) {
  PutSinkInput v{};
  v.sinkId = std::string("0");
...
PutSinkResponse RandomPutSinkResponse([[maybe_unused]] Rng& rng) {
  PutSinkResponse v{};
  if (rng.Coin()) v.note = rng.Text(1, 9);
  return v;
}

PutSinkOutput RandomPutSinkOutput([[maybe_unused]] Rng& rng) {
  PutSinkOutput v{};
...
Receipt RandomReceipt([[maybe_unused]] Rng& rng) {
  Receipt v{};
...
UploadAttachmentInput RandomUploadAttachmentInput([[maybe_unused]] Rng& rng) {
...
UploadAttachmentOutput RandomUploadAttachmentOutput([[maybe_unused]] Rng& rng) {
